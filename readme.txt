...
= 1.6.75 =
 ...
 - Now when saving and invalid product variant options are selected, an error will appear that the current state can not ber saved due to errors
  ...
  = 1.6.82 =
 - Fixed bug where the product option "Record count is quantity" could not be deactivated after beeing activated.
 ...
 = 1.6.85 =
 - Customer Billing details that can be forwarded automatically to the editor uppon opening are now also pushed in under the _Customer prefix e.g.: _CustomerFirstname, _CustomerAddress1
